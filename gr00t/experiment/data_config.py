...
class BiSo100TricamDataConfig(So100DataConfig):
...
class XlerobotDataConfig(BaseDataConfig):
    video_keys = ["video.top", "video.left", "video.right"]
    state_keys = [
        "state.left_arm",
        "state.left_gripper",
        "state.right_arm",
        "state.right_gripper",
        "state.mobile_base_translation",
        "state.mobile_base_yaw",
        "state.camera_mount",
    ]
    action_keys = [
        "action.left_arm",
        ...
        "action.mobile_base_translation",
        "action.mobile_base_yaw",
        "action.camera_mount",
    ]
    language_keys = ["annotation.human.task_description"]
    observation_indices = [0]
...
DATA_CONFIG_MAP = {
    ...
    "so100_tricam": BiSo100TricamDataConfig(),
    "xlerobot": XlerobotDataConfig(),
